...
export interface ThreeDSRequestorAuthenticationInfo {
	...
	threeDSReqAuthMethod?: "01" | "02" | "03" | "04" | "05" | "06" | "80" | "81" | "82" | "83" | "84" | "85" | "86" | "87" | "88" | "89" | "90" | "90" | "91" | "92" | "93" | "94" | "95" | "96" | "97" | "98" | "99"
...
export namespace ThreeDSRequestorAuthenticationInfo {
	export function is(value: ThreeDSRequestorAuthenticationInfo | any): value is ThreeDSRequestorAuthenticationInfo {
		return typeof value == "object" &&
			(value.threeDSReqAuthData == undefined || typeof value.threeDSReqAuthData == "string" && value.threeDSReqAuthData.length <= 2048) &&
