...
async function preauth(key: authly.Token, merchant: model.Merchant.Key, request: api.preauth.Request, token: authly.Token): Promise<api.preauth.Response | gracely.Error> {
...
async function auth(merchant: model.Merchant.Key, request: api.auth.Request): Promise<api.auth.Response | gracely.Error> {
...
async function postauth(merchant: model.Merchant.Key, request: api.postauth.Request): Promise<api.postauth.Response | gracely.Error> {
